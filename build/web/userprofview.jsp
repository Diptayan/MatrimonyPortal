...
%>
<%
String state="", city="", contact="",edulevel="", edufield="",workwith="",workas="",photo="";
ResultSet rs3=null;
try{
        Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
        Connection con = DriverManager.getConnection("jdbc:odbc:matrimony_DSN", "", "");
      ...
      <tr>
        <td width="100%" valign="top"><table width="100%" border="0" cellspacing="10" cellpadding="0">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td colspan="3" rowspan="9"><img name="" src="dp/<%=photo%>" width="294" height="192" alt="" border="4"></td>
              <td colspan="2">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td><span class="style3">Update Profile : </span></td>
              <td><a href="updateuser.jsp">Click Here</a></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
