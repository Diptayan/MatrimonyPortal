...
<%-- 
    Document   : search2
    Created on : 4 Jul, 2012, 9:13:47 AM
    Author     : Diptayan
--%>
...
<td width="95%" valign="bottom"><a href="logout_servlet"><h3><strong>Log Out</strong></h3></a></td>
  ...
  <tr>
    <td><span class="style2">Search for your best match here</span> </td>
  </tr>
</table>
<form method="post" action="showlist.jsp">
<table width="987" border="0">
            <tr>
              <th width="124" height="21" scope="col">&nbsp;</th>
              <th width="120" scope="col">&nbsp;</th>
              <th width="315" scope="col"> <a href="#" title="logout"></a></th>
              <th width="410" rowspan="9" scope="col"><img name="" src="galleryimages/image10_big.jpg" width="410" height="342" alt=""></th>
            </tr>
            <tr>
              <td height="37">&nbsp;</td>
              <td><h5 class="style3">Looking for </h5></td>
              <td><label>
            ...
            <tr>
              <td height="37">&nbsp;</td>
              <td><h5 class="style3">Religion</h5></td>
              <td><label>
...
<option value="Other" >Other</option>
            ...
            <tr>
              <td height="37">&nbsp;</td>
              <td><h5 class="style3">Mother tongue </h5></td>
...
<option value="Other">Other</option>
            ...
            <tr>
              <td height="37">&nbsp;</td>
              <td><h5 class="style3">Caste</h5></td>
    ...
    <option value="Other" label="Other">Other</option>
            ...
            <tr>
              <td height="37">&nbsp;</td>
              <td><h5 class="style3">State</h5></td>
          ...
          <option value="Pondicherry">Pondicherry</option>  
            ...
            <tr>
              <td height="37">&nbsp;</td>
              <td><h5 class="style3">Working with </h5></td>
              <td><select name="select9" size="1">
    ...
    <option value="Non Working" label="Non Working">Non Working</option>   </select></td>
            </tr>
            <tr>
              <td height="37">&nbsp;</td>
              <td><h5 class="style3">Working as </h5></td>
              <td><select name="select10" size="1">
