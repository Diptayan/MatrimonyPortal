...
%>
<%
String state="", city="", contact="",edulevel="", edufield="",workwith="",workas="",income="", describe="";
ResultSet rs3=null;
try{
        Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
        Connection con = DriverManager.getConnection("jdbc:odbc:matrimony_DSN", "", "");
          ...
          if(rs3.next())
            {
             ...
             income=rs3.getString(9);
             describe=rs3.getString(10);
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="47" colspan="2"><h1><strong>Update your Details-</strong></h1></td>
        <td width="338">&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td width="173"><h3><strong>Email</strong>:</h3></td>
        <td width="467"><input name="textfield3" type="text" id="textfield3" value="<%=email%>" readonly></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <td><label for="select"></label>
          <select name="select" id="select">
           <option selected="<%=marital%>"><%=marital%></option>
      ...
      <tr>
        ...
        <option value="" label="<%=height%>" selected="<%=height%>"><%=height%></option>
    ...
    <option value="84" label="7ft - 213cm">7ft - 213cm</option>
      ...
      <tr>
        ...
        <td><select name="select3" id="select3">
            <option value="" label="<%=caste%>" selected="<%=caste%>"><%=caste%></option>
    <optgroup id="caste-optgroup-Frequently Used" label="Frequently Used">    </optgroup>
    ...
    <optgroup id="caste-optgroup-More" label="More">    </optgroup>
    ...
    <option value="Other" label="Other">Other</option>
      ...
      <tr>
        ...
        <td><input type="text" name="textfield" id="textfield" value="<%= subcaste%>"></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><p>
          <label>
            <input name="RadioGroup1" type="radio" id="RadioGroup1_0" value="Veg" checked>
            Veg</label>
          <label>
            <input name="RadioGroup1" type="radio" id="RadioGroup1_1" value="Non-Veg">
            Non-Veg</label>
          <label>
      ...
      <tr>
        ...
        <td><p>
          <label>
            <input name="RadioGroup2" type="radio" id="RadioGroup2_0" value="No" checked>
            No</label>
          <label>
      ...
      <tr>
        ...
        <td><p>
          <label>
            <input name="RadioGroup3" type="radio" id="RadioGroup3_0" value="No" checked>
            No</label>
          <label>
      ...
      <tr>
        ...
        <td><p>
          <label>
            <input name="RadioGroup4" type="radio" id="RadioGroup4_0" value="Traditional" checked>
            Traditonal</label>
          <label>
      ...
      <tr>
        ...
        <td><p>
          <label>
            <input name="RadioGroup5" type="radio" id="RadioGroup5_0" value="Very Fair" checked>
            Very Fair</label>
          <label>
      ...
      <tr>
        ...
        <td><p>
          <label>
            <input name="RadioGroup6" type="radio" id="RadioGroup6_0" value="Slim" checked>
            Slim</label>
          <label>
      ...
      <tr>
        ...
        <td><select name="select5" id="select5">
                <option value="Select" selected="<%= city%>"><%=city%></option>
      ...
      <tr>
        ...
        <td><input type="text" name="textfield2" id="textfield2" value="<%= contact%>"></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="22" colspan="3">____________________________________________________________________________________________________________________________________________________________________</td>
      ...
      <tr>
        ...
        <td><select name="select6" id="select6" selected="">
            <option value="<%= edulevel%>" label="Select" selected="<%= edulevel%>"><%= edulevel%></option>
    ...
    <option value="High school" label="High school">High school</option>
      ...
      <tr>
        ...
        <option value="<%= edufield%>" label="Select" selected="<%= edufield%>"><%= edufield%></option>
    ...
    <option value="Travel &amp; Tourism" label="Travel &amp; Tourism">Travel &amp; Tourism</option>
      ...
      <tr>
        ...
        <td><select name="select8" id="select8" selected="">
         <option value="<%= workwith%>" label="Select" selected="<%= workwith%>"><%= workwith%></option>
    ...
    <option value="Non Working" label="Non Working">Non Working</option>
      ...
      <tr>
        ...
        <td><select name="select9" id="select9" selected="">
        <option value="<%= workas%>" label="Select" selected="<%= workas%>"><%= workas%></option>
    <optgroup id="occupation-optgroup-Accounting, Banking &amp; Finance" label="Accounting, Banking &amp; Finance">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Administration &amp; HR" label="Administration &amp; HR">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Advertising, Media &amp; Entertainment" label="Advertising, Media &amp; Entertainment">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Agriculture" label="Agriculture">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Airline &amp; Aviation" label="Airline &amp; Aviation">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Architecture &amp; Design" label="Architecture &amp; Design">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Artists, Animators &amp; Web Designers" label="Artists, Animators &amp; Web Designers">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Beauty, Fashion &amp; Jewellery Designers" label="Beauty, Fashion &amp; Jewellery Designers">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-BPO, KPO, &amp; Customer Support" label="BPO, KPO, &amp; Customer Support">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Civil Services / Law Enforcement" label="Civil Services / Law Enforcement">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Defense" label="Defense">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Education &amp; Training" label="Education &amp; Training">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Engineering" label="Engineering">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Hotel &amp; Hospitality" label="Hotel &amp; Hospitality">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-IT &amp; Software Engineering" label="IT &amp; Software Engineering">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Legal" label="Legal">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Medical &amp; Healthcare" label="Medical &amp; Healthcare">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Merchant Navy" label="Merchant Navy">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Sales &amp; Marketing" label="Sales &amp; Marketing">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Science" label="Science">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Corporate Professionals" label="Corporate Professionals">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Others" label="Others">    </optgroup>
    ...
    <optgroup id="occupation-optgroup-Non Working" label="Non Working">    </optgroup>
    ...
    <option value="Not working" label="Not working">Not working</option>
      ...
      <tr>
        ...
        <td><select name="select10" id="select10">
                <option value="<%= income%>" label="Select" selected="<%= income%>"><%= income%></option>
    ...
    <option value="Dont want to specify" label="Dont want to specify">Dont want to specify</option>
      ...
      <tr>
        ...
        <td><textarea name="textarea" id="textarea" cols="75" rows="5"><%= describe%></textarea></td>
        <td>&nbsp;</td>
      </tr>
       <tr>
        <td height="32">&nbsp;</td>
