...
try{
        ...
        PreparedStatement ps1 = con.prepareStatement("SELECT secq FROM reg1 WHERE email=?");
  ...
  <tr>
    ...
    <form method="post" action="forgot1_servlet">
      <table width="998" border="0">
        ...
        <tr>
          <td>&nbsp;</td>
          <td><input name="button" type="submit" class="blye-text-underline" id="button" value="Click To Know"></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
