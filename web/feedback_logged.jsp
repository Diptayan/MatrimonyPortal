...
<script language="javascript">
                         ...
                         function checklog()
                         {
                             if(email.value!=null){
                                 ...
                                 response.sendRedirect("feed_servlet1");
                             }
                         }
                        function givealert()
                        {
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
        <form method="POST"	onclick="checklog()" action="feed_servlet2">
  ...
  String name="";
    try{
        Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
        Connection con = DriverManager.getConnection("jdbc:odbc:matrimony_DSN", "", "");
        PreparedStatement ps2 = con.prepareStatement("SELECT name FROM reg1 where email=?");
...
%>
      <tr>
        ...
        <td><input name="textfield" type="text" id="textfield" onBlur ="checkEmail()" readonly value="<%=email%>"></td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td><input type="text" name="textfield2" id="textfield2" readonly value="<%= name%>"></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
...
<table width="100%" border="0">
 ...
 <%
   ...
   <tr>
    ...
    <td width="20%"><div align="center"><h2><%=name2%></h2></div></td>
    <td width="43%">
